...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Cartwise — Scan Groceries, Shop Smarter with AI",
      },
      {
...
function ScanPage() {
  ...
  async function handleFile(file?: File | null) {
    ...
    if (!quota.canScan) {
      toast.error(
        "You've used today's free scans. Go Pro for unlimited.",
      );
      return;
    }
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-5 pb-8 pt-10 sm:pt-16">
          ...
          <p className="mt-4 max-w-xl text-base text-muted-foreground">
            Snap a label, a piece of produce or an entire aisle.
            Cartwise scores it against your goal, calls out what's
            really inside, and hands you smarter swaps.
          </p>
        </div>
      </header>
            ...
            {quota.pro ? (
              ...
              <>
                ...
                <span className="text-muted-foreground">
                  ...
                  of {FREE_SCANS_PER_DAY} free scans left today
                </span>
              </>
            )}
          </div>
            ...
            {[
              {
                icon: Camera,
                title: "Snap anything",
                body: "Labels, produce, a whole shelf — one photo is enough.",
              },
              {
                icon: Sparkles,
                title: "Goal-aware score",
                body: "Every item is rated against the goal you picked.",
              },
              {
                icon: Leaf,
                title: "Better swaps",
